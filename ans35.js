var animalsNames = ["goat", "cow", "sheep", "buffalo"];
...
console.log("All these animals ".concat(animalsNames[0], ",").concat(animalsNames[1], ",").concat(animalsNames[2], " and ").concat(animalsNames[3], " meat is Halal"));
